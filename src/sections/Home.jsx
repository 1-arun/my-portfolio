...
const MediaIcon = [
  ...
  { href: "https://www.linkedin.com/in/codeswitharun/", icon: Icon.navIcon.LinkedIn },
  { href: "mailto:codeswitharun@gmail.com", icon: Icon.navIcon.Email },
  { href: "https://x.com/1Arun_", icon: Icon.socialIcons.Twitter },
  { href: "https://drive.google.com/file/d/1sJDE7nieX7Gka2-15P0eJwXy_6m4nMg5/view?usp=drivesdk", icon: Icon.navIcon.Download },
];
...
const Home = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center ">
      ...
      <p className="text-xl text-[#a3a3a3] mb-6  text-center ">
      ...
      <div className="flex flex-col justify-center items-center ">
        <div className=" flex gap-8 mb-6 justify-center items-center">
          ...
          <p className="text-white  bg-black p-2 border border-gray-300 dark:border-zinc-900 rounded-md hover:bg-zinc-900">
            Contact Me
          </p>
        </div>
          ...
          {MediaIcon.map(({ href, icon }, index) => {
            ...
            return (
              <li key={index} className="text-[#878787]  ">
                ...
                className={"items-center gap-2 hover:text-cyan-400 transition"}>
                  <IconComponent
