...
const ThemeToggle = () => {
  ...
  const options = [
    ...
    { label: "Dark", value: "dark", icon: <Moon className="w-4 h-4 text-white" /> },
    { label: "System", value: "system", icon: <span className="text-gray-500">🖥️</span> },
  ];

  const currentIcon = {
    light: <Sun className="w-5 h-5 text-yellow-500" size={20} strokeWidth={1.5} />,
  ...
  return (
    <div className="relative inline-block text-left">
      <button
        ...
        className="flex items-center gap-2 p-2 rounded-full bg-gray-200 dark:bg-gray-800"
      >
        {currentIcon[theme]}
